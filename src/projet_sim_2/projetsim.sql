...
--
-- Host: localhost    Database: projetsim
-- ------------------------------------------------------
...
CREATE TABLE `prescription` (
  ...
  KEY `lien_prescription_medicament_idx` (`mID`),
  CONSTRAINT `lien_prescription_medicament` FOREIGN KEY (`mID`) REFERENCES `medicament` (`mID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2015-05-05 13:23:35
